...
* 第一步：用户在你的网站点击购买 -> 向你的网站服务器发起支付订单 ->

* 第二步：用户扫码支付 -> 钱到你的微信/支付宝 -> app 监听到钱支付成功 ->

* 第三步：app 告诉网站服务器这个支付成功的消息 -> 网站服务器把这个消息回调给你的网站(notify_url)
...
> 2.本服务严禁用于违反中国互联网管理条例中任何一条有关危害互联网安全、侵犯他人知识产权等的违法行为。
